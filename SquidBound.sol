...
contract DividendDistributor is IDividendDistributor {
    ...
    uint256 public minimumTokenBalanceForDividends = 50000000 * (10**9); // user must hold 50,000,000 token
...
contract SQUIDBOUND is Ownable, IBEP20 {
    using SafeMath for uint256;
    ...
    string constant _name = "Hellbound Squid - The Game";
    string constant _symbol = "SQUIDBOUND";
